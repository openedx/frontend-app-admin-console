...
describe('TeamMemberViewActionCell', () => {
  ...
  it('navigates to the audit page for the row user', async () => {
    ...
    expect(mockNavigate).toHaveBeenCalledWith(`${AUTHZ_HOME_PATH}/user/johndoe`);
  });
  ...
  it('handles special characters in the username', async () => {
    ...
    expect(mockNavigate).toHaveBeenCalledWith(`${AUTHZ_HOME_PATH}/user/user%2Bwith%40special.chars`);
  });
